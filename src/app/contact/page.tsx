        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">support@codebite.com</p>
                  <p className="text-gray-600">partnerships@codebite.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">123 Developer Way</p>
            ...
            <div className="mt-10">
              ...
              <div className="flex gap-4">
                <Link href="#" className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200 transition">
          ...
          <div className="bg-gray-50 p-8 rounded-xl">
            ...
            <form className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full py-3 bg-gradient-to-r from-purple-600 to-blue-500 text-white rounded-lg hover:opacity-90 transition font-medium"
              >
                Send Message
              </Button>
            </form>
